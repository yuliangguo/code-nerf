...
class Encoder(nn.Module):
    ...
    def __init__(self, zero_init_residual=False,
        ...
        self.layer4_texture = self._make_layer(block, 512, layers[3], stride=2,
                                               dilate=replace_stride_with_dilation[2])
        self.avgpool = nn.AdaptiveAvgPool2d((1, 1))
        self.fc_shape = nn.Linear(512 * block.expansion, 256)
        self.fc_texture = nn.Linear(512 * block.expansion, 256)
